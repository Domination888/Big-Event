...
<template>
    <el-container class="layout-container">
        ...
        <el-container>
            <!-- 头部区域 -->
            <el-header>
                <div>欢迎回来 <strong>{{ userInfoStore.info.nickname ? userInfoStore.info.nickname : userInfoStore.info.usrename }}</strong></div>
            ...
            <!-- 底部区域 -->
            <el-footer>大事件 ©2025 Created by Domination</el-footer>
        </el-container>
    </el-container>
</template>
